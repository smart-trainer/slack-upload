...
var slack = __importStar(__webpack_require__(570));
function run() {
    return __awaiter(this, void 0, void 0, function () {
        var token, channels, filePath, fileName, fileType, title;
        return __generator(this, function (_a) {
            ...
            fileName = core.getInput('file-name') || path.parse(filePath).name;
            fileType = core.getInput('file-type') || path.parse(filePath).ext;
            title = core.getInput('title') || 'New Slack Upload from Github Action';
...
function upload(slackToken, channels, filePath, fileName, fileType, title) {
    var _a, _b;
    return __awaiter(this, void 0, void 0, function () {
        var client, file, result, response, error_1;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    _c.trys.push([0, 2, , 3]);
                    client = new slack.WebClient(slackToken, {
                ...
                case 1:
                    ...
                    if (result.ok == false) {
                        ...
                        return [2 /*return*/, Promise.resolve((_b = result.error) !== null && _b !== void 0 ? _b : 'unknown error')];
                    }
                ...
                case 2:
                    ...
                    return [2 /*return*/, Promise.resolve(error_1.message)];
